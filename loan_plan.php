    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="landing.php">
                <div class="sidebar-brand-text mx-3">CrowdFunding</div>
            </a>
			...
			<li class="nav-item">
                <a class="nav-link" href="track_donation.php">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Tack Donation</span></a>
            </li>
			<li class="nav-item">
            ...
            <footer class="stocky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CrowdFunding <?php echo date("Y")?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
